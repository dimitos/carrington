...
{block main}
    {include "views/pages/country/hero.tpl"}
    {include "views/pages/country/welcome.tpl"}
    {include "views/pages/country/culture.tpl"}
    {include "views/pages/country/history.tpl"}
    {include "views/pages/country/sport.tpl"}
